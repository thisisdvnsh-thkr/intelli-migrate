...
-- ============================================
-- Generated: 2026-04-05T22:31:53.108636
-- Dialect: POSTGRESQL
-- Tables: 5
-- Records: 107
-- ============================================
...
INSERT INTO customer_orders (id, category, unit_price, phone, quantity)
VALUES
    (1, 'Electronics', 79.99, '+1-555-123-4567', 2),
    (2, 'Electronics', 149.99, '123', 1),
    (3, 'Accessories', 45.0, '+1 (555) 246-8135', 3),
    (4, 'Electronics', 89.99, '+44-20-7946-0958', 2),
    (5, 'Storage', 129.99, '', 1),
    (6, 'Accessories', 19.99, '555-333-4444', 10),
    (7, 'Electronics', 34.99, '+91-9876543210', 0),
    (8, 'Electronics', 39.99, '+30-210-1234567', 2),
    (9, 'Lighting', 0.0, '+1-310-555-0199', 4),
    (10, 'Electronics', 249.99, '+82-2-1234-5678', 1),
    (11, 'Audio', 199.99, 'ABC-DEF-GHIJ', 2),
    (12, 'Office Supplies', 42.99, '+1-570-555-0100', 100),
    (13, 'Tools', 15.99, '+1-555-000-0000', 1),
    (14, 'Audio', 59.99, '+1-555-123-4567', 1),
    (15, 'Office Supplies', 24.99, '+1-570-555-0101', 5),
    (16, 'Photography', 799.99, '+1-212-555-1234', 1),
    (17, 'Electronics', 49.99, '+1-604-555-9999', 3),
    (18, 'Lighting', 79.99, '1-555-FASHION', 1),
    (19, 'Wearables', 149.99, '+1-555-194-1', 1),
    (20, 'Wearables', 399.99, '+1-310-555-IRON', 50),
    (21, 'Fitness', 34.99, '+1-555-KILL-BILL', 2),
    (22, 'Computer Parts', 1299.99, '+1-313-555-0001', 1);